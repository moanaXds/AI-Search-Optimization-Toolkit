...
* Prints the best solution per generation
* Shows final selected items, total value, and total weight
* Can be adapted for other GA problems (e.g., secret word guessing)

---

## Extensions

* Secret word optimization via GA (character string evolution)
* Adjustable population size, mutation probability, and max generations
* Visualizations of fitness evolution over generations
